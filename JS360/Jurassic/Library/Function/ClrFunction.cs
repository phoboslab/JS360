...
namespace Jurassic.Library
{
    ...
    public class ClrFunction : FunctionInstance
    {
        ...
        /// <summary>
        /// Load the ClrFunction's Binder methods from the given Type
        /// </summary>
        /// <param name="type">Type to load the Binder methods from</param>
        public void LoadBinderFromType(Type type)
        {
            if (this.callBinder != null)
                this.callBinder.LoadFromType(type);
            if (this.constructBinder != null)
                this.constructBinder.LoadFromType(type);
        }
